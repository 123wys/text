  ...
  <div>
    ...
    <div class="map">
      ...
      <div class="content">
        <div class="txt">
          <ul>
            <li class="mailIcon"></li>
            <li>邮箱：</li>
            <li>xflow_support@zhongan.io</li>
          </ul>

          <ul>
            <li class="positionIcon"></li>
            <li>地 址：</li>
            <li>众安信息技术服务有限公司</li>
            <li>深圳市前海深港合作区前湾一路1号A栋201室（深圳总公司）</li>
            <li>众安信息技术服务有限公司上海分公司</li>
            <li>上海市虹口区东大名路391-393号4楼A4109室</li>
            <li>上海市黄浦区圆明园路209号真光大楼</li>
          </ul>
        </div>
      </div>
    </div>
